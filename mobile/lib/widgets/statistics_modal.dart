                        ...
                        StreamBuilder<int>(
                          ...
                          builder: (context, snapshot) {
                            return Text(
                              '${snapshot.data ?? 0}',
                              style: Theme.of(context).textTheme.titleLarge?.copyWith(
                                color: (snapshot.data ?? 0) > 0 ? Colors.red : Colors.grey,
                                fontWeight: FontWeight.bold,
                              ),
                            );
                          },
                    ...
                    [
                      ...
                      _buildStatCard(
                        ...
                        StreamBuilder<int>(
                          stream: Stream.periodic(const Duration(seconds: 1), (i) => i),
                          builder: (context, snapshot) {
                            final count = _statisticsService.currentSampleCount;
                            return Text(
                              '$count',
                              style: Theme.of(context).textTheme.titleLarge?.copyWith(
                                fontWeight: FontWeight.bold,
                        ...
                        StreamBuilder<double?>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            return Column(
                              children: [
                                Text(
                                  realTimeAvg != null ? '${realTimeAvg.toStringAsFixed(1)}' : '--',
                                  style: Theme.of(context).textTheme.headlineMedium?.copyWith(
                                    fontWeight: FontWeight.bold,
                                    color: _getDecibelColor(realTimeAvg ?? 0),
                                  ),
                                ),
                                Text(
                                  'dB SPL',
